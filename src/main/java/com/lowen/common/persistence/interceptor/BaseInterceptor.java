package com.lowen.common.persistence.interceptor;
...
import com.lowen.common.persistence.dialect.db.DerbyDialect;
import com.lowen.common.persistence.dialect.db.H2Dialect;
import com.lowen.common.persistence.dialect.db.HSQLDialect;
import com.lowen.common.persistence.dialect.db.MySQLDialect;
import com.lowen.common.persistence.dialect.db.OracleDialect;
...
public abstract class BaseInterceptor implements Interceptor, Serializable {
    ...
    public static ThreadLocal<Dialect> threadLocalDialect = new ThreadLocal<Dialect>();
    ...
    protected void initProperties(Properties p) {
    	...
    	String dbType = null;
    	dbType = Global.getConfig("jdbc.type");
        ...
        DIALECT = dialect;
        //支持不同线程下不同的数据源分页
        threadLocalDialect.set(dialect);
